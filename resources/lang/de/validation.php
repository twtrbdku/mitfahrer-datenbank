...
return [
    ...
    */
    ...
    'before_or_equal' => 'Das Attribut :attribute muss ein Datum vor oder gleich dem :date sein.',
    'between' => [
    ...
    'required_with_all' => 'Das Attributfeld :attribute ist erforderlich, wenn :Werte vorhanden sind.',
    'required_without' => 'Das Attributfeld :attribute ist erforderlich, wenn :values nicht vorhanden ist.',
    'required_without_all' => 'Das Attributfeld :attribute wird benötigt, wenn keiner der :Werte vorhanden ist.',
